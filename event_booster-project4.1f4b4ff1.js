let t,a;var n="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},s={},o={},l=n.parcelRequire42eb;function i(t,a){return Math.random()*(a-t)+t}null==l&&((l=function(t){if(t in s)return s[t].exports;if(t in o){var a=o[t];delete o[t];var n={id:t,exports:{}};return s[t]=n,a.call(n.exports,n,n.exports),n.exports}var l=Error("Cannot find module '"+t+"'");throw l.code="MODULE_NOT_FOUND",l}).register=function(t,a){o[t]=a},n.parcelRequire42eb=l),l.register,Object.assign(l.i??={},{"9v6fF":"symbol-defs.c5b0f01c.svg"}),document.querySelectorAll(".star").forEach((t,a)=>{t.style.left=`${i(0,100)}%`,t.style.top=`${i(0,100)}%`;let n=i(2,4);t.style.width=`${n}px`,t.style.height=`${n}px`,t.style.animationDelay=`${.5*a}s`});let d=1,c=[],r=1;const m={itemsContainer:document.querySelector(".hero__list"),paginationContainer:document.getElementById("hero__pagination")},u=`
      ...
      {{/each}}
`,_=Handlebars.compile(u);async function p(t){try{if(51!=t){var a;let n=await fetch(`https://app.ticketmaster.com/discovery/v2/events.json?apikey=ketKoDmJUHl7Ak2zwntgxzeJRJUvRMXS&size=20&page=${t-1}`);if(n.ok||console.error("Помилка API"),!(c=(null==(a=(await n.json())._embedded)?void 0:a.events)||[]).length){m.itemsContainer.innerHTML='<p class="hero__message >Event not found</p>',m.paginationContainer.innerHTML="";return}(function(){let t=_({items:c.map(t=>{var a,n,s,o,l;let i=t.images||[],d=i.find(t=>"16_9"===t.ratio&&t.width>300)||i[0];return{id:t.id,name:t.name||"Без назви",date:(null==(n=t.dates)||null==(a=n.start)?void 0:a.localDate)||"Дата не вказана",place:(null==(l=t._embedded)||null==(o=l.venues)||null==(s=o[0])?void 0:s.name)||"Місце не вказане",image:{url:d?d.url:"#"}}})});m.itemsContainer.innerHTML=t})(),h()}else m.itemsContainer.innerHTML='<p class="hero__message">No more events now</p>',h()}catch(t){console.error("Помилка:",t),m.itemsContainer.innerHTML='<p class="hero__message >Error loading events</p>'}}function h(){m.paginationContainer.innerHTML="";let t=Math.floor(2.5),a=r,n=Math.min(a+5-1,51);for(let s=a;s<=n;s++){let o=document.createElement("button");o.classList.add("hero__btn"),o.textContent=s,s===d?o.classList.add("hero__btn-active"):o.classList.remove("hero__btn-active"),o.addEventListener("click",()=>{p(d=s),s===a+t&&s<51-t?r=Math.min(r+1,47):s===a+t-1&&a>1?r=Math.max(1,a-1):s===n&&s<51?r=s:s===a&&a>1&&(r=Math.max(1,s-5+1)),h()}),m.paginationContainer.appendChild(o)}if(n<51){let t=document.createElement("span");t.classList.add("hero__dots"),t.textContent="...",m.paginationContainer.appendChild(t);let a=document.createElement("button");a.classList.add("hero__btn"),a.textContent=51,51===d?a.classList.add("hero__btn-active"):a.classList.remove("hero__btn-active"),a.addEventListener("click",()=>{r=47,p(d=51)}),m.paginationContainer.appendChild(a)}}p(d);const v=document.querySelector(".header__search"),g=document.querySelector("#hero__items");async function y(t){let a=[],n=0,s=1;try{for(;n<s;){var o;let l=await fetch(`https://app.ticketmaster.com/discovery/v2/events.json?apikey=L7VlP0GtWQZMHhIkOqz3A3FcxX8k8AWD&keyword=${t}&size=20&page=${n}`),i=await l.json(),d=(null==(o=i._embedded)?void 0:o.events)||[];a.push(...d),s=i.page.totalPages,n++}}catch(t){console.log(t)}return a}async function f(t){let a=(await y(t)).filter(a=>a.name.toLowerCase().includes(t.toLowerCase()));if(0===a.length){g.innerHTML="<h2>There are no such events</h2>";return}var n=a.slice(0,20);let s=`
...
//# sourceMappingURL=event_booster-project4.1f4b4ff1.js.map
