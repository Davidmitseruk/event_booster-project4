let e,t;var a="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},o={},s=a.parcelRequire42eb;function l(e,t){return Math.random()*(t-e)+e}null==s&&((s=function(e){if(e in n)return n[e].exports;if(e in o){var t=o[e];delete o[e];var a={id:e,exports:{}};return n[e]=a,t.call(a.exports,a,a.exports),a.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){o[e]=t},a.parcelRequire42eb=s),s.register,Object.assign(s.i??={},{"9v6fF":"symbol-defs.c5b0f01c.svg","2t5Vk":"close.20c71eb8.png",jWCQC:"ticket1.6f0c7b1d.png"}),document.querySelectorAll(".star").forEach((e,t)=>{e.style.left=`${l(0,100)}%`,e.style.top=`${l(0,100)}%`;let a=l(2,4);e.style.width=`${a}px`,e.style.height=`${a}px`,e.style.animationDelay=`${.5*t}s`});let i=1,c=[],r=1;const d={itemsContainer:document.querySelector(".hero__list"),paginationContainer:document.getElementById("hero__pagination")},m=`
      ...
      {{/each}}
`,u=Handlebars.compile(m);async function _(e){try{if(51!=e){var t;let a=await fetch(`https://app.ticketmaster.com/discovery/v2/events.json?apikey=ketKoDmJUHl7Ak2zwntgxzeJRJUvRMXS&size=20&page=${e-1}`);if(a.ok||console.error("Помилка API"),!(c=(null==(t=(await a.json())._embedded)?void 0:t.events)||[]).length){d.itemsContainer.innerHTML='<p class="hero__message >Event not found</p>',d.paginationContainer.innerHTML="";return}(function(){let e=u({items:c.map(e=>{var t,a,n,o,s;let l=e.images||[],i=l.find(e=>"16_9"===e.ratio&&e.width>300)||l[0];return{id:e.id,name:e.name||"Без назви",date:(null==(a=e.dates)||null==(t=a.start)?void 0:t.localDate)||"Дата не вказана",place:(null==(s=e._embedded)||null==(o=s.venues)||null==(n=o[0])?void 0:n.name)||"Місце не вказане",image:{url:i?i.url:"#"}}})});d.itemsContainer.innerHTML=e})(),p()}else d.itemsContainer.innerHTML='<p class="hero__message">No more events now</p>',p()}catch(e){console.error("Помилка:",e),d.itemsContainer.innerHTML='<p class="hero__message >Error loading events</p>'}}function p(){d.paginationContainer.innerHTML="";let e=Math.floor(2.5),t=r,a=Math.min(t+5-1,51);for(let n=t;n<=a;n++){let o=document.createElement("button");o.classList.add("hero__btn"),o.textContent=n,n===i?o.classList.add("hero__btn-active"):o.classList.remove("hero__btn-active"),o.addEventListener("click",()=>{_(i=n),n===t+e&&n<51-e?r=Math.min(r+1,47):n===t+e-1&&t>1?r=Math.max(1,t-1):n===a&&n<51?r=n:n===t&&t>1&&(r=Math.max(1,n-5+1)),p()}),d.paginationContainer.appendChild(o)}if(a<51){let e=document.createElement("span");e.classList.add("hero__dots"),e.textContent="...",d.paginationContainer.appendChild(e);let t=document.createElement("button");t.classList.add("hero__btn"),t.textContent=51,51===i?t.classList.add("hero__btn-active"):t.classList.remove("hero__btn-active"),t.addEventListener("click",()=>{r=47,_(i=51)}),d.paginationContainer.appendChild(t)}}_(i);const h=document.querySelector(".header__search"),g=document.querySelector("#hero__items");async function v(e){let t=[],a=0,n=1;try{for(;a<n;){var o;let s=await fetch(`https://app.ticketmaster.com/discovery/v2/events.json?apikey=L7VlP0GtWQZMHhIkOqz3A3FcxX8k8AWD&keyword=${e}&size=20&page=${a}`),l=await s.json(),i=(null==(o=l._embedded)?void 0:o.events)||[];t.push(...i),n=l.page.totalPages,a++}}catch(e){console.log(e)}return t}async function y(e){let t=(await v(e)).filter(t=>t.name.toLowerCase().includes(e.toLowerCase()));if(0===t.length){g.innerHTML="<h2>There are no such events</h2>";return}var a=t.slice(0,20);let n=`
...
</div>`,F=Handlebars.compile(O);async function z(e){try{let t=await fetch(`https://app.ticketmaster.com/discovery/v2/events/${e}.json?apikey=ketKoDmJUHl7Ak2zwntgxzeJRJUvRMXS`),a=await t.json();console.log(a);let n=a?function(e){var t,a,n,o,s,l,i,c,r,d,m,u,_,p,h,g,v,y,b,f,L,k,E,w,S,T,M;return{id:e.id,image:(null==(a=e.images)||null==(t=a[0])?void 0:t.url)||"",info:(M=e.info,M?(M.match(/[^.!?]+[.!?]+/g)||[M]).slice(0,2).join(" ").trim()||M:"No aleviable"),date:(null==(o=e.dates)||null==(n=o.start)?void 0:n.localDate)||"N/A",time:(null==(l=e.dates)||null==(s=l.start)?void 0:s.localTime)?e.dates.start.localTime.slice(0,5):"N/A",location:(null==(r=e._embedded)||null==(c=r.venues)||null==(i=c[0])?void 0:i.name)||"N/A",city:(null==(_=e._embedded)||null==(u=_.venues)||null==(m=u[0])||null==(d=m.city)?void 0:d.name)||"N/A",country:(null==(v=e._embedded)||null==(g=v.venues)||null==(h=g[0])||null==(p=h.country)?void 0:p.name)||"N/A",venue:(null==(f=e._embedded)||null==(b=f.venues)||null==(y=b[0])?void 0:y.name)||"N/A",artists:(null==(k=e._embedded)||null==(L=k.attractions)?void 0:L.map(e=>e.name).join(", "))||"Unknown artist",priceStandard:(null==(w=e.priceRanges)||null==(E=w[0])?void 0:E.min)?`${e.priceRanges[0].min} USD`:"50 USD",priceVIP:(null==(T=e.priceRanges)||null==(S=T[0])?void 0:S.max)?`${e.priceRanges[0].max} USD`:"70 USD"}}(a):{},o=F(n);N.modalContainer.innerHTML=o;let s=document.querySelector(".backdrop__poster"),l=document.querySelector(".modal__btn-close");return s.classList.remove("is-hidden"),l.addEventListener("click",()=>{s.classList.add("is-hidden"),N.modalContainer.innerHTML=""}),s.addEventListener("click",e=>{e.target===s&&(s.classList.add("is-hidden"),N.modalContainer.innerHTML="")}),n}catch(e){console.error(e,"Error with fetch current id item")}}N.dataCards?N.dataCards.addEventListener("click",async e=>{let t=e.target.closest(".hero__item");if(t){let e=t.dataset.id;await z(e)}}):console.error("Element not found");const P=document.querySelectorAll(".footer__team-nav-btn"),W=document.querySelectorAll(".footer__team-item"),J={openModalBtn:document.querySelector("[data-team-open]"),closeModalBtn:document.querySelector(".footer__close-team-modal"),modal:document.querySelector("[data-team]")};function K(){J.modal.classList.toggle("is-hidden"),document.body.classList.toggle("no-scroll")}function V(e){W.forEach(e=>{e.classList.add("hide")});let t=document.querySelector(`.footer__team-item:nth-child(${e})`);t&&t.classList.remove("hide")}J.openModalBtn.addEventListener("click",e=>{K(),V(1)}),J.closeModalBtn.addEventListener("click",K),P.forEach(e=>{e.addEventListener("click",e=>{V(parseInt(e.target.id)),P.forEach(e=>e.classList.remove("footer__btn-active")),e.target.classList.add("footer__btn-active")})});
//# sourceMappingURL=event_booster-project4.8e29baf6.js.map
