...
</div>`,O=Handlebars.compile(j);async function F(e){try{let t=await fetch(`https://app.ticketmaster.com/discovery/v2/events/${e}.json?apikey=ketKoDmJUHl7Ak2zwntgxzeJRJUvRMXS`),a=await t.json();console.log(a);let n=a?P(a):{},s=O(n);N.modalContainer.innerHTML=s;let o=document.querySelector(".backdrop__poster");return o.classList.remove("is-hidden"),o.addEventListener("click",e=>{e.target===o&&(o.classList.add("is-hidden"),N.modalContainer.innerHTML="")}),n}catch(e){console.error(e,"Error with fetch current id item")}}function P(e){var t,a,n,s,o,l,i,c,r,d,m,u,_,p,h,v,g,y,f,b,L,E,k,w,S,T,M;return{id:e.id,image:(null==(a=e.images)||null==(t=a[0])?void 0:t.url)||"",info:(M=e.info,M?(M.match(/[^.!?]+[.!?]+/g)||[M]).slice(0,2).join(" ").trim()||M:"No aleviable"),date:(null==(s=e.dates)||null==(n=s.start)?void 0:n.localDate)||"N/A",time:(null==(l=e.dates)||null==(o=l.start)?void 0:o.localTime)?e.dates.start.localTime.slice(0,5):"N/A",location:(null==(r=e._embedded)||null==(c=r.venues)||null==(i=c[0])?void 0:i.name)||"N/A",city:(null==(_=e._embedded)||null==(u=_.venues)||null==(m=u[0])||null==(d=m.city)?void 0:d.name)||"N/A",country:(null==(g=e._embedded)||null==(v=g.venues)||null==(h=v[0])||null==(p=h.country)?void 0:p.name)||"N/A",venue:(null==(b=e._embedded)||null==(f=b.venues)||null==(y=f[0])?void 0:y.name)||"N/A",artists:(null==(E=e._embedded)||null==(L=E.attractions)?void 0:L.map(e=>e.name).join(", "))||"Unknown artist",priceStandard:(null==(w=e.priceRanges)||null==(k=w[0])?void 0:k.min)?`${e.priceRanges[0].min} USD`:"N/A",priceVIP:(null==(T=e.priceRanges)||null==(S=T[0])?void 0:S.max)?`${e.priceRanges[0].max} USD`:"N/A"}}N.dataCards?N.dataCards.addEventListener("click",async e=>{let t=e.target.closest(".hero__item");if(t){let e=t.dataset.id;await F(e);let a=document.querySelector(".fav__list"),n=[];document.body.addEventListener("click",async e=>{if(e.target&&"addBtn"===e.target.id)try{console.log(e.target.dataset.id);let t=await F(e.target.dataset.id),s=P(t);console.log(s),n.push(s),function(e){if(0===e.length){a.innerHTML="<li><p>There are not favourites events</p></li>";return}let t=e.filter(e=>{var t,a,n,s,o;return(null==e||null==(a=e.dates)||null==(t=a.start)?void 0:t.localDate)&&(null==e||null==(o=e._embedded)||null==(s=o.venues)||null==(n=s[0])?void 0:n.name)}),n=`
         {{#each this}}
